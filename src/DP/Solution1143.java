...
public class Solution1143 {
    ...
    public static void main(String[] args) {
        ...
        for(int i=0; i < n; i++) {
            ...
            String text1 = fr.next();
            String text2 = fr.next();
            out.println(sol.longestCommonSubsequence(text1, text2));
        }
        out.close();
    }
    ...
    private int dp(int index1, String text1, int index2, String text2) {
        if(index1 == text1.length() || index2 == text2.length()) {
            return 0;
        }

        if(text1.charAt(index1) == text2.charAt(index2)) {
            return dp(index1+1, text1, index2+1, text2) + 1;
        }

        return Math.max(dp(index1+1, text1, index2, text2), dp(index1, text1, index2+1, text2));
    }
